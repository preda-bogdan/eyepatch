...
const visualCompare = require('./visual_compare').visualCompare;


const jobsManager = require( './jobs_manager' ).jobsManager
...
exports.execute = function () {
	...
	console.time( 'jobs' )
	console.time( 'eyepatch_' + global.config.name )
	let jobs = new jobsManager( json.jobs )
	jobs.expand().run( function () {
		new visualCompare( json.jobs ).diff()
